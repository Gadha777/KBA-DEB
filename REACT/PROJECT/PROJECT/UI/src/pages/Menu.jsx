...
const Menu = () => {
  const [menus, setMenus] = useState(null); // Single object or null
    ...
    const fetchMenus = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setMenus(data); // Set single reservation object
        } 
      } catch (error) {
  ...
  return (
   <>
      ...
      {/* <!-- another menu --> */}
     <div className="h-[300px] bg-[url('/backgroundimg/6.jpg')] bg-cover bg-no-repeat mt-"style={{ backgroundImage: `url(${imagePath2})` }} >
