...
import imagePath from '../assets/Backgrounds/backgroundimg/5.jpg';
...
const Login = () => {
  ...
  return (
    <div
  className="relative  bg-cover bg-center min-h-screen flex items-center justify-center" style={{ backgroundImage: `url(${imagePath})` }}>
  {/* Blur Effect */}
  <div className="absolute inset-9 bg-white rounded-md ml-[385px] w-[450px]"></div>

  {/* Login Form */}
  <div className="relative  p-8 sm:p-12 rounded-lg  w-full max-w-md">
