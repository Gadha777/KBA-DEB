...
const Reservation = () => {
  ...
  return (
    <div
      className="bg-cover bg-no-repeat bg-fixed min-h-screen" style={{ backgroundImage: `url(${imagePath})` }}>
     ...
     <Navbar />
      ...
      <div>
        <button
          type="button"className="hover:bg-red-900 bg-white text-black px-4 py-2 mt-10 ml-[550px] rounded-full " value="BOOK">
...
<div>
  ...
  {/* phone number */}
<label className="text-xl " htmlFor="">Phone No</label>
<br/>
<input type="text"
       id='phoneno'
       value={phoneno}
...
{/* table Id */}
<div>
<label className="text-xl ml-10" htmlFor="">Table Id</label>
<br/>
<input type="text"
      id='tableid'
      value={tableid}
...
<div className="flex">
<div> 
<label className="text-xl " htmlFor="">No of people</label>
<br/><br/>
...
{/* date */}
<div>
<label className="text-xl ml-10" htmlFor="">Date</label>
<br/><br/>
...
<div className="flex">
<div>
<label className="text-xl" htmlFor="">Suggestions</label>
<br/><br/>
...
{/* Time */}
<div>
<label className="text-xl ml-10" htmlFor="">Time</label>
<br/><br/>
<input className="border-2 border-orange-400 h-8 w-48 ml-10"
      type="time" 
      id='time'
