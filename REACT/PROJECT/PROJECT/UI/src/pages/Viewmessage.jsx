...
const Viewmessage = () => {
    ...
    useEffect(() => {
        const fetchMessages = async () => {
            try {
              const response = await fetch('http://localhost:3000/api/allmessages', {
                method: 'GET',
                headers: {
  ...
  return (
    <div className="container mx-auto p-6 bg-cover bg-fixed m-1 m-[-50px] h-[700px]"  style={{ backgroundImage: `url(${img1 })` }}>
      <Navbar/>
