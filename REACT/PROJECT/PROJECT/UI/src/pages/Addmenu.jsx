...
const Addmenu = () => {
  ...
  return (
    <>
    <Navbar />
    <div className="bg-black-100 min-h-screen flex items-center justify-center bg-cover bg-fixed mt-[-200px]"  style={{ backgroundImage: `url(${img1 })` }}>
    <div className="w-full mt-[260px] max-w-md p-8 bg-white/80 rounded-lg shadow-md">
      <h2 className="text-2xl font-bold text-center text-red-900 mb-6">Add New Dish</h2>
      <form onSubmit={Addmenu} className="space-y-4 mt-10">
        <div>
