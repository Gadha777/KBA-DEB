...
//    else
//    {
//     res.status(404).json({message:"you don't have permission"})
//    }
})
...
adminroute.get('/logout', (req, res) => {
    try {
      ...
      res.clearCookie('Authtoken', {
        httpOnly: true,
        sameSite: 'Strict', // Ensure cookie is only sent for same-site requests
        secure: true, // Ensure the cookie is sent only over HTTPS in production
      });
